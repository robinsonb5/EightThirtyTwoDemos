...
derive_pll_clocks 
create_generated_clock -name sd1clk_pin -source [get_pins {myVirtualToplevel|guest|pll|altpll_component|auto_generated|pll1|clk[0]}] [get_ports {SDRAM_CLK}]
create_generated_clock -name sysclk -source [get_pins {myVirtualToplevel|guest|pll|altpll_component|auto_generated|pll1|clk[1]}]
...
set_multicycle_path -from [get_clocks {sd1clk_pin}] -to [get_clocks {myVirtualToplevel|guest|pll|altpll_component|auto_generated|pll1|clk[1]}] -setup -end 2
