...
#set_multicycle_path -from {VirtualToplevel:myvirtualtoplevel|sdram_cached:mysdram|DirectMappedCache:\GENDCACHE:mytwc|*} -to {VirtualToplevel:myvirtualtoplevel|pipeline:mycpu|*} -setup -end 2
#set_multicycle_path -from {VirtualToplevel:myvirtualtoplevel|sdram_cached:mysdram|DirectMappedCache:\GENCACHE:mytwc2|*} -to {VirtualToplevel:myvirtualtoplevel|pipeline:mycpu|*} -setup -end 2
#set_multicycle_path -from {VirtualToplevel:myvirtualtoplevel|sdram_cached:mysdram|DirectMappedCache:\GENDCACHE:mytwc|*} -to {VirtualToplevel:myvirtualtoplevel|pipeline:mycpu|*} -hold -end 2
#set_multicycle_path -from {VirtualToplevel:myvirtualtoplevel|sdram_cached:mysdram|DirectMappedCache:\GENCACHE:mytwc2|*} -to {VirtualToplevel:myvirtualtoplevel|pipeline:mycpu|*} -hold -end 2
